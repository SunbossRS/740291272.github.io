...
//换肤功能 主题颜色控制器
function appColor() {
	var mainColor = localStorage.yoone_color || '#F44336',
		secColor = '#FFC107';
...
//组装"关于"面板
function aboutPanel() {
	var html = '<div class=aboutApp><p><b>自杀清单，一个郁郁症患者的死亡时间管理工具。</b><br>活着有什么用<br><p>不会自杀：看看这本书：<a href="data/CompleteSuicideManual(CH).pdf" >《完全自杀マニュアル》</a></p><p>程序BaseOn：@2016 <a href="http://liaokeyu.com/about.html" target="_blank">廖柯宇</a></p><p>改：Gloomy Ghost</p></div>';
	$('.menu-subCard').html(html);
}
